...
class BudgetManager:
    ...
    async def check_availability(self, user_id: str, project_id: Optional[str] = None, estimated_cost: float = 0.0) -> bool:
        """
    ...
    def check_availability_sync(self, user_id: str, project_id: Optional[str] = None, estimated_cost: float = 0.0) -> bool:
        """
    ...
    async def record_spend(self, user_id: str, cost: float, project_id: Optional[str] = None, model: Optional[str] = None) -> None:
        """
    ...
    def record_spend_sync(self, user_id: str, cost: float, project_id: Optional[str] = None, model: Optional[str] = None) -> None:
        """
