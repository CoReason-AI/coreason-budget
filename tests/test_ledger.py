...
@pytest.mark.asyncio
async def test_ledger_connection_success(redis_url):
...
@pytest.mark.asyncio
async def test_ledger_connection_failure(redis_url):
...
@pytest.mark.asyncio
async def test_close(ledger):
    """Test close connection."""
    await ledger.close()
    assert ledger._redis is None

@pytest.mark.asyncio
async def test_auto_connect_get_usage(redis_url):
...
@pytest.mark.asyncio
async def test_auto_connect_increment(redis_url):
...
@pytest.mark.asyncio
async def test_get_usage_error(ledger):
...
@pytest.mark.asyncio
async def test_increment_error(ledger):
...
@pytest.mark.asyncio
async def test_get_usage(ledger):
...
@pytest.mark.asyncio
async def test_increment_no_ttl(ledger):
...
@pytest.mark.asyncio
async def test_increment_with_ttl(ledger):
...
@pytest.mark.asyncio
async def test_increment_new_key_ttl(ledger):
